...
// condition added for  errors handelling ......
        ...
        <div class="timer ">
          <h1 class="bg-black text-white mt-40 ml-48 px-2">${iform.others.posted_date}</h1>
        </div>
        </figure>
        <div class="card-body">
        ...
        <svg id="verified" class="verified-badge ${author.verified ? '' : 'hidden'} 
